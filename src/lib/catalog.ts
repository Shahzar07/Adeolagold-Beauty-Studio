...
export const products: Product[] = [
  {
    ...
    images: [
      img("black-bob-lace-front", "Sleek black bob lace front wig, front view on a studio block", "product"),
      img("black-bob-lace-side", "Sleek black bob lace front wig, side profile", "product"),
      img("black-bob-lace-back", "Sleek black bob lace front wig, back view showing the blunt cut", "product"),
      img("black-bob-lace-detail", "Close-up of the HD lace front and pre-plucked hairline", "detail"),
      img("black-bob-lace-worn", "Client wearing the sleek black bob lace front wig", "portrait"),
    ],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [
      img("natural-bob-front", "Natural black sleek bob wig, front view", "product"),
      img("natural-bob-side", "Natural black sleek bob wig, side profile", "product"),
      img("natural-bob-back", "Natural black sleek bob wig, back view", "product"),
      img("natural-bob-detail", "Close-up of the Remy hair texture and cap", "detail"),
  ...
  },
  {
    ...
    images: [
      img("lace-30-front", "13x6 straight lace front wig at 30 inches, front view", "product"),
      img("lace-30-side", "13x6 straight lace front wig, side profile showing length", "product"),
      img("lace-30-back", "13x6 straight lace front wig, back view showing fullness", "product"),
      img("lace-30-detail", "Close-up of the 13x6 lace and parting", "detail"),
      img("lace-30-texture", "Macro texture study of the silky straight hair", "texture"),
  ...
  },
  {
    ...
    images: [
      img("body-wave-bundle-hero", "Body wave human hair bundles arranged on linen", "product"),
      img("body-wave-bundle-weft", "Close-up of the double weft on the body wave bundles", "detail"),
      img("body-wave-bundle-texture", "Macro texture study of the body wave pattern", "texture"),
      img("body-wave-bundle-worn", "Client wearing a body wave install", "portrait"),
    ],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [
      img("straight-bundle-hero", "Straight human hair bundles arranged on linen", "product"),
      img("straight-bundle-weft", "Close-up of the double weft on the straight bundles", "detail"),
      img("straight-bundle-texture", "Macro texture study of the silky straight hair", "texture"),
  ...
  },
  {
    ...
    images: [
      img("hd-frontal-hero", "13x4 HD lace frontal laid flat", "product"),
      img("hd-frontal-lace", "Close-up of the Swiss HD lace and bleached knots", "detail"),
      img("hd-frontal-parting", "The frontal parted to show hairline density", "detail"),
      img("hd-frontal-worn", "Client wearing an HD frontal install", "portrait"),
    ],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [
      img("closure-hero", "4x4 lace closure laid flat", "product"),
      img("closure-lace", "Close-up of the 4x4 lace and baby hairs", "detail"),
      img("closure-parting", "The closure parted to show the hairline", "detail"),
      img("closure-worn", "Client wearing a closure install", "portrait"),
    ],
    inStock: true,
